...
payments AS (
    SELECT fd.fund_distributions__fund_id AS fund_id,
           ...
           SUM(CASE LOWER(COALESCE(fd.fund_distributions__distribution_type, ''percentage''))
