...
CREATE TABLE IF NOT EXISTS report_templates (
    ...
    category ENUM('acquisitions', 'circulation', 'inventory', 'finance', 'users', 'cataloging', 'other') DEFAULT 'other',
    ...
    execution_config JSON NULL COMMENT 'Optional reusable report execution metadata',
